...
`,V={root:function(t){var o=t.props,r=t.instance;return["p-badge p-component",{"p-badge-circle":O(o.value)&&String(o.value).length===1,"p-badge-dot":w(o.value)&&!r.$slots.default,"p-badge-sm":o.size==="small","p-badge-lg":o.size==="large","p-badge-xl":o.size==="xlarge","p-badge-info":o.severity==="info","p-badge-success":o.severity==="success","p-badge-warn":o.severity==="warn","p-badge-danger":o.severity==="danger","p-badge-secondary":o.severity==="secondary","p-badge-contrast":o.severity==="contrast"}]}},R=x.extend({name:"badge",style:U,classes:V}),M={name:"BaseBadge",extends:P,props:{value:{type:[String,Number],default:null},severity:{type:String,default:null},size:{type:String,default:null}},style:R,provide:function(){return{$pcBadge:this,$parentInstance:this}}};function l(n){"@babel/helpers - typeof";return l=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},l(n)}function k(n,t,o){return(t=Q(t))in n?Object.defineProperty(n,t,{value:o,enumerable:!0,configurable:!0,writable:!0}):n[t]=o,n}function Q(n){var t=Y(n,"string");return l(t)=="symbol"?t:t+""}function Y(n,t){if(l(n)!="object"||!n)return n;var o=n[Symbol.toPrimitive];if(o!==void 0){var r=o.call(n,t);if(l(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(n)}var z={name:"Badge",extends:M,inheritAttrs:!1,computed:{dataP:function(){return p(k(k({circle:this.value!=null&&String(this.value).length===1,empty:this.value==null&&!this.$slots.default},this.severity,this.severity),this.size,this.size))}}},Z=["data-p"];function q(n,t,o,r,h,d){return i(),g("span",u({class:n.cx("root"),"data-p":d.dataP},n.ptmi("root")),[b(n.$slots,"default",{},function(){return[T(S(n.value),1)]})],16,Z)}z.render=q;var G=({dt:n})=>`
.p-button {
    display: inline-flex;
    cursor: pointer;
    user-select: none;
